...
//     const existingCartItems = cartItems.findIndex((item) => item.id === product.id);
...
//           <Route path="/login" element={<LoginPage token = {token} setToken = {setToken} apiData = {apiData} setUserId = {setUserId} />} />
